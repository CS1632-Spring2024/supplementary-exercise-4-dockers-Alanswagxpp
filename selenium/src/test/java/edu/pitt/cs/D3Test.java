...
public class D3Test {
  ...
  //   assertThat(driver.findElement(By.xpath("//div[@id=\'feedResult\']")).getText(), is("Cat flight!"));
  // }
  ...
  public void tEST3CATALOG() {
    ...
    {
      WebElement element = driver.findElement(By.xpath("(//img[@src])[2]"));
      String attribute = element.getAttribute("src");
      vars.put("secondItem", attribute);
    }
    assertEquals(vars.get("secondItem").toString(), "http://localhost:8080/images/cat2.jpg");
  }
  ...
  public void tEST4LISTING() {
    ...
    vars.put("numberOfCats", driver.findElements(By.xpath("//div[@id=\'listing\']/ul/li")).size());
    assertEquals(vars.get("numberOfCats").toString(), "3");
